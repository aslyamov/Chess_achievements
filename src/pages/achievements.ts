...
const ICON_LIBRARY = [
  ...
  { name: 'rank2',               label: '2 место' },
  { name: 'rank3',               label: '3 место' },
  ...
  { name: 'burning-star',        label: 'Горящая звезда' },
  { name: 'star-formation',      label: 'Созвездие' },
  { name: 'shining-star',        label: 'Яркая звезда' },
  ...
  { name: 'level-up',            label: 'Уровень вверх' },
  { name: 'lightning-bolt',      label: 'Молния' },
  ...
  { name: 'flash',               label: 'Вспышка' },
  { name: 'shield',              label: 'Щит' },
  { name: 'shield-crest',        label: 'Щит герб' },
  { name: 'tower-shield',        label: 'Башенный щит' },
  { name: 'sword',               label: 'Меч' },
  { name: 'crossed-swords',      label: 'Мечи скрещ.' },
  { name: 'war',                 label: 'Война' },
  { name: 'castle',              label: 'Замок' },
  { name: 'fortress',            label: 'Крепость' },
  { name: 'tower',               label: 'Башня' },
  { name: 'knight-helmet',       label: 'Шлем рыцаря' },
